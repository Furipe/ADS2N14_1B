...
public class PessoaController
{
	...
	public void criarContato()
	{
		...
		for (int i=1;i<=50;i++)
		{
			...
			contato.setTipo(geraTipoFone());
		}
	}

	public void exibirContato(ContatoView view)
	{
		view.printContato(contato.getNome(), contato.getFone(), contato.getEndereco(), contato.getTipo(), contato.getCodArea());
	}

	public String geraTipoFone()
	{
	...
	public String geradorFone ()
	{
		...
		//Gerar o código de área com 2 digitos
		while (codArea<10)
		{
		...
		//Gerar o Numéro de 3 digitos
		while (fone<100)
		{
			fone=gerador.nextInt(999);
			if (fone>=100)
			{
				//Gerar o Numéro de 4 digitos
				while (controle<1000)
				{
	...
	public String geradorEndereco ()
	{
		...
		return listaTipo.get(numTipo)+" "+listaPatente.get(numPatente)+" "+listaNomes.get(numNome)+" "+listaSobre.get(numSobre)+", "+numero;
	}
}